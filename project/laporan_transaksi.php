...
<body>
    ...
    <ul>
        ...
        // Sample data
        $transactions = [
            ['nama kue' => 'Lapis legit', 'Harga' => 15000,'Jumlah' => 1, 'Metode Pembayaran' => 'Bank Transfer','Nama pembeli' => 'zidan', 'Alamat' => 'cibarusah', 'Nomor Hp' => '089514751811'],
        ];
        ...
        foreach ($transactions as $transaction) {
            ...
            echo "<span>Pembeli: {$transaction['Nama pembeli']}</span>";
