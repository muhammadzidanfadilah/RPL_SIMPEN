        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="javascript:void(0);" onclick="loadDashboard('Pendaftaran.php')">Pendaftaran</a></li>
                    <li class="nav-item"><a class="nav-link" href="javascript:void(0);" onclick="loadDashboard('login.php')">Login</a></li>
                    <li class="nav-item"><a class="nav-link" href="javascript:void(0);" onclick="loadDashboard('katalog_kue.php')">Katalog Kue</a></li>
                    <li class="nav-item"><a class="nav-link" href="javascript:void(0);" onclick="loadDashboard('Keranjang.php')">Keranjang</a></li>
                    <li class="nav-item"><a class="nav-link" href="javascript:void(0);" onclick="loadDashboard('checkout.php')">Checkout</a></li>
                    <li class="nav-item"><a class="nav-link" href="javascript:void(0);" onclick="loadDashboard('laporan_transasksi.php')">Laporan Transaksi</a></li>
                    <li class="nav-item"><a class="nav-link" href="javascript:void(0);" onclick="loadDashboard('logout.php')">Logout</a></li>
